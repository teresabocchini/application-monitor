...
class MacDetailsTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cellIdentifier = "MacTableViewCell"
        
        guard let cell = tableView.dequeueReusableCell(withIdentifier: cellIdentifier, for: indexPath) as? MacTableViewCell else {
        ...
        cell.macURLButton.setTitle("\(application?.name ?? "Application") Source", for: .normal)
