...
class WindowsDetailsTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cellIdentifier = "WindowsTableViewCell"
        
        guard let cell = tableView.dequeueReusableCell(withIdentifier: cellIdentifier, for: indexPath) as? WindowsTableViewCell else {
        ...
        cell.windowsURLButton.setTitle("\(application?.name ?? "Application") Source", for: .normal)
